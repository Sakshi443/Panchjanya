...
import { Command, CommandGroup, CommandItem, CommandList, CommandEmpty, CommandInput } from "@/shared/components/ui/command";
import { Separator } from "@/shared/components/ui/separator";
import { cn } from "@/shared/lib/utils"; // Assumes shadcn's utility for class merging
        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    ...
                    size="sm"
                    className={cn(
                        "h-11 w-full justify-between border-gray-200 transition-colors duration-150 hover:bg-muted focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-xl",
